...
class Tableseating extends \Opencart\System\Engine\Controller {
		private $error = array();
		...
		public function index() {
			...
			$this->load->language('extension/purpletree_multivendor/multivendor/tableseating');
			...
			$this->load->model('extension/purpletree_multivendor/multivendor/tableseating');
		...
		public function add() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->model_extension_purpletree_multivendor_multivendor_tableseating->addAttribute($this->customer->getId(),$this->request->post);
				...
				$this->response->redirect($this->url->link('extension/purpletree_multivendor/multivendor/tableseating','language=' . $this->config->get('config_language'), true));
			}
		...
		public function edit() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->model_extension_purpletree_multivendor_multivendor_tableseating->editSellerAttribute($this->request->post);
		...
		public function delete() {
			...
			if (isset($this->request->post['selected'])) {
				foreach ($this->request->post['selected'] as $attribute_id) {
					$this->model_extension_purpletree_multivendor_multivendor_tableseating->deleteSellerAttribute($attribute_id);
				}
		...
		protected function getList() {
			...
			'href' => $this->url->link('extension/purpletree_multivendor/multivendor/tableseating',  $url.'&language=' . $this->config->get('config_language'), true)
			);
			$this->load->model('extension/purpletree_multivendor/multivendor/dashboard');
			
			$this->model_extension_purpletree_multivendor_multivendor_dashboard->checkSellerApproval();
			
			$data['add'] = $this->url->link('extension/purpletree_multivendor/multivendor/tableseating|add','language=' . $this->config->get('config_language'),true);
			$data['delete'] = $this->url->link('extension/purpletree_multivendor/multivendor/tableseating|delete','language=' . $this->config->get('config_language'),true);
			...
			$atrribute_total = $this->model_extension_purpletree_multivendor_multivendor_tableseating->getTotalAttributes($this->customer->getId());
			
			$results = $this->model_extension_purpletree_multivendor_multivendor_tableseating->getSellerAtrributes($this->customer->getId(),$filter_data);
			...
			foreach ($results as $result) {
				...
				'edit'       => $this->url->link('extension/purpletree_multivendor/multivendor/tableseating|edit', '&attribute_id=' . $result['id'].$url.'&language=' . $this->config->get('config_language'), true)
				);
			}
			...
			$data['sort_name'] = $this->url->link('extension/purpletree_multivendor/multivendor/tableseating' , $url.'&language=' . $this->config->get('config_language'), true);
			$data['sort_code'] = $this->url->link('extension/purpletree_multivendor/multivendor/tableseating',  '&sort=code' . $url.'&language=' . $this->config->get('config_language'), true);
			$data['sort_discount'] = $this->url->link('extension/purpletree_multivendor/multivendor/tableseating', '&sort=discount' . $url, true);
			$data['sort_date_start'] = $this->url->link('extension/purpletree_multivendor/multivendor/tableseating', '&sort=date_start' . $url.'&language=' . $this->config->get('config_language'), true);
			$data['sort_date_end'] = $this->url->link('extension/purpletree_multivendor/multivendor/tableseating', '&sort=date_end' . $url.'&language=' . $this->config->get('config_language'), true);
			$data['sort_status'] = $this->url->link('extension/purpletree_multivendor/multivendor/tableseating', '&sort=status' . $url.'&language=' . $this->config->get('config_language'), true);
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('extension/purpletree_multivendor/multivendor/tableseating', '' . $url . '&page={page}'.'&language=' . $this->config->get('config_language'), true)
		]);
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($atrribute_total) ? (($page - 1) * $this->config->get('config_pagination_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_pagination_admin')) > ($atrribute_total - $this->config->get('config_pagination_admin'))) ? $atrribute_total : ((($page - 1) * $this->config->get('config_pagination_admin')) + $this->config->get('config_pagination_admin')), $atrribute_total, ceil($atrribute_total / $this->config->get('config_pagination_admin')));
			...
			$this->response->setOutput($this->load->view('extension/purpletree_multivendor/multivendor/tableseating_list', $data));
		}
		...
		protected function getForm() {
			...
			if (!isset($this->request->get['attribute_id'])) {
				$data['action'] = $this->url->link('extension/purpletree_multivendor/multivendor/tableseating|add','language=' . $this->config->get('config_language'),true);
				} else {
				$data['action'] = $this->url->link('extension/purpletree_multivendor/multivendor/tableseating|edit','&attribute_id=' . $this->request->get['attribute_id'].'&language=' . $this->config->get('config_language') , true);
			}
			$data['cancel'] = $this->url->link('extension/purpletree_multivendor/multivendor/tableseating','language=' . $this->config->get('config_language'), true);
			
			$this->load->model('localisation/language');
			
			
			$datag = $this->model_extension_purpletree_multivendor_multivendor_tableseating->getOtherSellerAttributeGroups();
			...
			$data['attribute_groups'] = $this->model_extension_purpletree_multivendor_multivendor_tableseating->getSellerAttributeGroups($stringgattr);
			
			$data['languages'] = $this->model_localisation_language->getLanguages();
			
			if (isset($this->request->get['attribute_id']) && (!$this->request->server['REQUEST_METHOD'] != 'POST')) {
				$attribute_info = $this->model_extension_purpletree_multivendor_multivendor_tableseating->getSellerAttribute($this->request->get['attribute_id']);
			}
			...
			if (isset($this->request->post['attribute_description'])) {
				...
				$data['attribute_description'] = $this->model_extension_purpletree_multivendor_multivendor_tableseating->getSellerAttributeDescriptions($this->request->get['attribute_id']);
				} else {
			...
			$this->response->setOutput($this->load->view('extension/purpletree_multivendor/multivendor/tableseating_form', $data));
		}
		...
		public function history() {
			...
			$results = $this->model_extension_purpletree_multivendor_multivendor_tableseating->getCouponHistories($this->request->get['attribute_id'], ($page - 1) * 10, 10);
			...
			$history_total = $this->model_extension_purpletree_multivendor_multivendor_tableseating->getTotalCouponHistories($this->request->get['attribute_id'],$this->customer->getId());
			$url ='';
