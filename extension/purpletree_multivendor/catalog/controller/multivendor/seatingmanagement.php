...
class Seatingmanagement extends \Opencart\System\Engine\Controller {
		...
		public function add() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->model_extension_purpletree_multivendor_multivendor_seatingmanagement->addAttribute($this->customer->getId(),$this->request->post);
		...
		public function edit() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->model_extension_purpletree_multivendor_multivendor_seatingmanagement->editSellerAttribute($this->request->post);
		...
		public function delete() {
			...
			if (isset($this->request->post['selected'])) {
				foreach ($this->request->post['selected'] as $attribute_id) {
					$this->model_extension_purpletree_multivendor_multivendor_seatingmanagement->deleteSellerAttribute($attribute_id);
				}
		...
		protected function getList() {
			...
			$atrribute_total = $this->model_extension_purpletree_multivendor_multivendor_seatingmanagement->getTotalAttributes($this->customer->getId());
			
			$results = $this->model_extension_purpletree_multivendor_multivendor_seatingmanagement->getSellerAtrributes($this->customer->getId(),$filter_data);
			...
			foreach ($results as $result) {
				...
				'edit'       => $this->url->link('extension/purpletree_multivendor/multivendor/seatingmanagement|edit', '&attribute_id=' . $result['id'].$url.'&language=' . $this->config->get('config_language'), true)
				);
			}
		...
		protected function getForm() {
			...
			if (!isset($this->request->get['attribute_id'])) {
				...
				$data['action'] = $this->url->link('extension/purpletree_multivendor/multivendor/seatingmanagement|edit','&attribute_id=' . $this->request->get['attribute_id'].'&language=' . $this->config->get('config_language') , true);
			}
			...
			$datag = $this->model_extension_purpletree_multivendor_multivendor_seatingmanagement->getOtherSellerAttributeGroups();
			...
			$data['attribute_groups'] = $this->model_extension_purpletree_multivendor_multivendor_seatingmanagement->getSellerAttributeGroups($stringgattr);
			
			$data['languages'] = $this->model_localisation_language->getLanguages();
			
			if (isset($this->request->get['attribute_id']) && (!$this->request->server['REQUEST_METHOD'] != 'POST')) {
				$attribute_info = $this->model_extension_purpletree_multivendor_multivendor_seatingmanagement->getSellerAttribute($this->request->get['attribute_id']);
			}
			...
			if (isset($this->request->post['attribute_description'])) {
				...
				$data['attribute_description'] = $this->model_extension_purpletree_multivendor_multivendor_seatingmanagement->getSellerAttributeDescriptions($this->request->get['attribute_id']);
				} else {
		...
		public function history() {
			...
			$results = $this->model_extension_purpletree_multivendor_multivendor_seatingmanagement->getCouponHistories($this->request->get['attribute_id'], ($page - 1) * 10, 10);
			...
			$history_total = $this->model_extension_purpletree_multivendor_multivendor_seatingmanagement->getTotalCouponHistories($this->request->get['attribute_id'],$this->customer->getId());
			$url ='';
